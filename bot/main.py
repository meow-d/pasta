...
async def dice(ctx, faces=6):
    try:
        ...
        await ctx.send(
            ctx.author.mention + " state a number larger than 1 you dumb dumb"
        )
...
async def emoji(ctx):
    ...
    await ctx.send(
        "<:Pokimane:761513674056794112> <:lmao:761792146571264050> <a:dancin:762655521730986015> <a:dancin:762655521730986015> <a:dancin:762655521730986015> <a:dancin:762655521730986015> <a:dancin:762655521730986015> <a:dancin:762655521730986015>"
    )
...
async def join(ctx):
    ...
    try:
        ...
        await ctx.send(
            ctx.author.mention + " connect to a voice channel first you big dumb"
        )
    else:
